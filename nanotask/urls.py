...
urlpatterns = [
    ...
    url(r'^assignment/update/(?P<project_name>\w+)/(?P<status>\w+)/$', views.update_assignment_status, name="update_assignment_status"),
    url(r'^assignment/update_comment/(?P<project_name>\w+)/$', views.update_assignment_comment, name="update_assignment_comment"),
